...
//         `It is a Friday afternoon, and the bank is crowded as many customers are withdrawing money before the weekend. The cashier, Mr. Arun, is following the token system to serve customers in order.
// Suddenly, Mr. Ravi, a middle-aged man, rushes to the counter without a token and demands an urgent cash withdrawal of 2 lakhs. He looks visibly anxious and says,
// I have a medical emergency, and I need this cash immediately! I don’t have time to wait for a token!
// Mr. Arun, maintaining protocol, replies, Sir, we have a long queue, and we are following the token system. Please take a token, and your turn will come shortly.
// Mr. Ravi becomes agitated and raises his voice, attracting attention from other customers. He insists,
// This is ridiculous! You should understand my urgency. If something happens to my relative because of this delay, will you take responsibility?
// The other customers start murmuring, some sympathizing with Mr. Ravi and others demanding fairness. The tension in the branch escalates.
// At this moment, as the Branch Manager, you step in to manage the situation.
// `,
        ...
        <div className={styles.createBox} ref={createButtonsRef}>
          <div
            onClick={() => {
              ...
              clearAllData();
              localStorage.setItem("timeLine", JSON.stringify(true)); //to show the timeLine
            }}
          >
            {" "}
            <PersonIcon />
