  ...
  return (
    ...
    >
      ...
      >
        ...
        {(currentPage != "DocumentFile" && currentPage != "moduleLists" && currentPage != "sessions")&&<img src={data?.thumbnail_url?data.thumbnail_url:`${import.meta.env.VITE_APP_URL}avatarImg1.jpg`} alt="" />}
        {(currentPage == "moduleLists"||currentPage == "sessions")&&<img src={data?.info?.thumbnail_url?data?.info?.thumbnail_url:`${import.meta.env.VITE_APP_URL}avatarImg1.jpg`} alt="" />}
