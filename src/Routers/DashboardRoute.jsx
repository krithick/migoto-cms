...
import AssignBulkCourse from '../Pages/AssignCourse/AssignBulkCourse.jsx'
function DashboardRoute() {
  return (
    ...
    <Routes>
              ...
              <Route path="createUser/assignCourse" element={<AssignBulkCourse />} />
              <Route
                path="createUser/assignCourse/:id"
                element={<AssignBulkCourse />}
              />
              <Route
