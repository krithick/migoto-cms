...
function UserRoute() {
  return (
    <>
      ...
      <Route path="users/:id/assignCourse/:id" element={<AssignBulkCourse />} />
      ...
      <Route path="users/:id/module/assignCourse/:id" element={<AssignBulkCourse />} />
      <Route path="users/:id/scenario" element={<UserScenario />} />
      <Route path="users/:id/scenario/editUser" element={<EditUser />} />
      <Route path="users/:id/scenario/assignCourse/:id" element={<AssignBulkCourse />} />
