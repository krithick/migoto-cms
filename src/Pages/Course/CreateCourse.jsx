...
function CreateCourse({currentPage, setCurrentPage, setData, courseDetail }) {
  ...
  useEffect(() => {
    ...
    if (courseDetail) {
      ...
      setPreview(import.meta.env.VITE_COURSE_PREVIEW)
      setSelectedFile(import.meta.env.VITE_COURSE_PREVIEW)
    }
  }, [courseDetail]);
          ...
          if (flow == "CourseManagement & editCourse flow") {
            ...
            navigate(-1);
                localStorage.setItem(
                  "TLData",
                  JSON.stringify(TimeLineRoute["/migoto-cms/createUser/assignCourse/:id"])
                );
                UpdateTimeline(
                  1,
                  {
