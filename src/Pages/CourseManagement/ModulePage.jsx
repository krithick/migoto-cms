...
function ModulePage() {
  ...
  const fetchListOfCourse = () => {
    let course_id = selectedData["showCourse"]
      ? selectedData["showCourse"]
      : getSessionStorage("showCourse");
    let module_id = selectedData["showModule"]
      ? selectedData["showModule"]
      : getSessionStorage("showModule");
    let scenario_id = selectedData["showScenario"]
      ? selectedData["showScenario"]
      : getSessionStorage("showScenario");
